Feature: Project initialization
  ...
  Scenario: Fresh init creates expected structure
    ...
    And the target should have directory ".claude"
    And the target should have file ".claude/agents/jr/coder.md"
    And the target should have file ".claude/prompts/jr/subagent-task.md"
    And the target should have symlink "justfile"
    And the target should have directory ".jr/claude/_/agents/jr"
    And the target should have directory ".jr/claude/_/prompts/jr"
    And the target should have directory ".jr/claude/_/rules"
    And the target should have file ".claude/rules/jr/structure.md"
